    ...
    <div class="col-md-12">
        <div class="box box-danger">
            <div class="box-header">
                <h3 class="box-title">{{ trans('backend/title.users.create') }}</h3>
            </div>
            {!! Form::open(array('route' => 'backend.users.store', 'method' => 'POST', 'class' => 'form-horizontal'))  !!}
                <div class="box-body">
                    ...
                    <div class="form-group {{formHasError('gender')}}">
                        ...
                        <div class="col-sm-9">
                            <label>{!! Form::radio('gender', SEX_MALE, true)!!}{{trans('backend/table.users.male') }}</label>
                            <label>{!! Form::radio('gender', SEX_FEMALE, false)!!}{{trans('backend/table.users.female') }}</label>
                        </div>
